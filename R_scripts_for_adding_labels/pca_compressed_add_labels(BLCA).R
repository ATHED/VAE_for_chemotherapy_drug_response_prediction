...
write.table(merge.chemo.label.data,
            file="/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/counts_data/pca_compressed/encoded_rnaseq_BLCA_pca_0.9_wLabels(og,5cancers,unlabel,0.2_var,all_sample).txt",
            sep="\t",
            quote=FALSE,
            row.names=T,
            col.names=NA)
