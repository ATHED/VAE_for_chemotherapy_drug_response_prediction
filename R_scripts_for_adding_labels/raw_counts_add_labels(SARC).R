...
#################################################
#expression data
expr.data <- read.table("/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/counts_data/high_var_counts_data/TCGA_SARC_(0.2chemo)VSTnrom_count_expr_clinical_data.txt", sep="\t",
...
write.table(merge.chemo.label.data,
            file="/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/counts_data/counts_data_with_label/TCGA_SARC_(0.2chemo_2labels)VSTnrom_count_expr_clinical_data.txt",
            sep="\t",
            quote=FALSE,
            row.names=T,
            col.names=NA)
