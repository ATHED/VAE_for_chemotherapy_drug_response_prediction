...
#################################################
#expression data
expr.data <- read.table("/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/counts_data/vae_compressed/encoded_5cancers_rnaseq_vae(perSp,a1.0,unlabel,0.2_var,3LFS12k,z50,minmax).tsv", sep="\t",
...
#################################
#clinical data
cli.data <- read.table ("/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/clinical_data/TCGA-PAAD-binary-labels.txt", sep="\t",
...
write.table(merge.chemo.label.data,
            file="/media/qiwei/work/Python_playground/VAE/TCGA_5_cancers/counts_data/vae_compressed_wLabels/encoded_PAAD_rnaseq_vae_binaryLabels(perSp,a1.0,unlabel,0.2_var,3LFS12k,z50,minmax).txt",
            sep="\t",
            quote=FALSE,
            row.names=T,
            col.names=NA)
